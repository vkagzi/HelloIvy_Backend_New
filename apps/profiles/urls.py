...
from .views import GetProfileView, UpdateProfileView, ResumeParserView, TranscriptParserView, LinkedInParserView
...
urlpatterns = [
    ...
    path("parse-linkedin/", LinkedInParserView.as_view(), name="parse_linkedin"),
]
