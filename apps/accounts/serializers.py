...
class UserPaymentSerializer(serializers.ModelSerializer):  # type: ignore[type-arg]
    ...
    class Meta:
        ...
        read_only_fields = ["id", "user_email", "user_first_name", "user_last_name", "metadata", "created_at", "updated_at"]
...
class SchoolPaymentSerializer(serializers.ModelSerializer):  # type: ignore[type-arg]
    ...
    class Meta:
        ...
        read_only_fields = ["id", "school_name", "metadata", "created_at", "updated_at"]
